...
Specify an output filename for the compiled simulation and add all the source files to command along with the needed testbench, once that's done run vvp on the output file.
If the testbench should included a vcd dump, you can then launch surfer with the vcd file to inspect the testbench values. 
