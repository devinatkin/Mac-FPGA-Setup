F4PGA has a good guide on creating custom makefiles for your projects, for a more extensive explanation go to: https://f4pga-examples.readthedocs.io/en/latest/customizing-makefiles.html.
...
It contains all the requried instructions to the toolchain to export a bitstream file. 